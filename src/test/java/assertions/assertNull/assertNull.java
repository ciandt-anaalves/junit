package test.java.assertions.assertNull;
...
public class assertNull {
    ...
    @Test
    public void assertNullSemMensagem() {
        ...
        Livro actualLivro = livroService.getLivroById(4L);
        assertNull(actualLivro);
    }

    @Test
    public void assertNullComMensagem() {
        LivroService livroService = new LivroService();
        ...
        Livro actualLivro = livroService.getLivroById(4L);
        assertNull(actualLivro, "O livro não é null!");
    }

    @Test
    public void assertNullComMensagemSupplier() {
        LivroService livroService = new LivroService();
